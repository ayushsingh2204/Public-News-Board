...
var black = deepFreeze(deepMerge(base, {
    global: {
        colors,
        drop: {
            background: '#444444',
...
var light = deepFreeze(deepMerge(base, {
    global: {
        breakpoints: {
            small: {
                size: {
...
var materiallight = deepFreeze(deepMerge(base, {
    global: {
        colors: colors$2,
        drop: {
            background: '#f8f8f8',
...
var materialdark = deepFreeze(deepMerge(base, {
    global: {
        colors: colors$3,
        drop: {
            background: '#2a2a2a',
...
var metro = deepFreeze(deepMerge(base, {
    global: {
        colors: colors$4,
        drop: {
            background: '#005696',
...
export { base, black, colorsFromArray, colorsFromObject, light, materialdark, materiallight, metro };
